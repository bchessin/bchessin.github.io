...
export const classOfferings = [
  ...
  { number: '02', title: 'HIIT', eyebrow: 'Power + pace', description: 'Short, focused intervals that build conditioning without losing the fun. Work at your level with clear coaching, intentional recovery, and a strong finish.', details: ['45 minutes', 'Group class', 'In person · F45'], availability: 'F45 schedule / inquire', color: 'coral' },
