...
function TrustStrip() { return <div className="trust-strip" aria-label="Training formats"><span>F45 HIIT / in person</span><i /><span>Zumba / Google Meet</span><i /><span>Private coaching</span><i /><span>All levels welcome</span></div>; }
